...
class Model:
    ...
    Gli archi devono indicare le rotte tra gli aeroporti collegati tra di loro da almeno un volo. 
    Il peso dell’arco rappresenta la “distanza media percorsa” tra i due aeroporti.
    idMap nella query.
    """
